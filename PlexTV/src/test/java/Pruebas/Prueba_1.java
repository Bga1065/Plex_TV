...
public class Prueba_1 {
	...
	public void testGooglePage() {
		...
		driver.findElement(By.cssSelector("#radix-\\:Rckm\\: > div > div.p8jtya6m.p8jtya9q.p8jtya7q.p8jtya8m.oywxfn0.oywxfn2.oywxfn5.oywxfn7 > span > div > div.p8jtya12.p8jtya9.p8jtya4e.p8jtya1q.p8jtya1n.p8jtya2i.p8jtya2m.p8jtya32.p8jtya3m > button.nckz222.p8jtya16.p8jtya32.p8jtya3m.p8jtyam.nckz22b.j6xja40.p8jtyaf6.nckz228")).click();
		driver.manage().window().maximize();
		driver.findElement(By.id("email")).sendKeys("jfinhXD@gmail.com");
		driver.findElement(By.id("password")).sendKeys("pollolandia12");
		driver.findElement(By.cssSelector("#radix-\\:r9\\: > div > div > div > span > div > div > div > div.p8jtya12.p8jtya9.p8jtya4a.p8jtya1q.p8jtya2i.p8jtya2q > form > div > button")).click();
	}
